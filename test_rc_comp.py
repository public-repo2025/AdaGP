...
from CGP.algo import RCBase1_comp, PRCIE_ind_log_comp
from functions import test_rc_comp
...
c = 10
beta = 0.1
folder0 = './results/test_rc_comp'
params = 'c;B;m;beta;n;w;l;seed;seed_p;pois\n'+str(c)+';'+str(B)+';<m>;'+str(beta)+';<n>;<w>;<l>;<seed>;<seed_p>;<pois>'


PRCIE_func_dist = lambda x,rhos,Bvec,func_proj,args: PRCIE_ind_log_comp(x,func_proj,c,rhos,beta,Bvec,args=args)
func_base1 = lambda x,rhos,Bvec,func_proj,args: RCBase1_comp(x,rhos,Bvec,func_proj,args=args)


mech_cgp_base1 = ('CGP Base_dist',2,budget_rho_rem,func_base1,Bvec_init)

mech_cgp_prcie_dist  = ('CGP PRCIE_dist',4,budget_rho_rem,PRCIE_func_dist,Bvec_init)

mechs = [mech_cgp_base1,mech_cgp_prcie_dist]
...
tick = time()
print('Starting test_rc_taxi_sq_comp for range'+str(run_range[0])+' - '+str(run_range[-1]))
...
for jrep in run_range:
    ...
    for j in range(len(ws)):
        ...
        test_rc_comp(dict_traj,times,B,seed,ps, rect_w=w,rect_l=l,params_in=params_in,mechs=mechs,folder_out0=folder_out,b_interim=False,b_analysis=True)
